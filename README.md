...
A program to demonstrate some BackgroundWorker functions
...
> Download source code on [GitHub](https://github.com/OliverKind/OLKI.Programme.BwDemo/archive/master.zip)
...
I use a versioning system similar [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/OliverKind/OLKI.Programme.BwDemo/tags). 
...
See also the list of [contributors](https://github.com/OliverKind/OLKI.Programme.BwDemo/contributors) who participated in this project.
